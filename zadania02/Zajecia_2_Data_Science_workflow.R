...
# 2.	przygotowanie danych: podgl¹d danych, porz¹dkowanie nazw, typów, braków, czyszczenie danych
# 3.	scalenie obu ramek danych w jedn¹ (analogia WYSZUKAJ.PIONOWO w Excelu)
# 4.	podstawowa analiza z u¿yciem pakietu dplyr: mutate/filter/select/arrange/group_by/summarise
# 5.	wizualizacja [* zaawansowane *] z u¿yciem pakietu ggplot2
...
# pierwsze 6 wierszy (obserwacji)
head(kraje_1)	
head(kraje_2)      
# pierwsze 10 wierszy (obserwacji)
head(kraje_1, 10)	
head(kraje_2, 10)
# ostatnie 5 wierszy (obserwacji)
tail(kraje_1, 5)	
tail(kraje_2, 5)
